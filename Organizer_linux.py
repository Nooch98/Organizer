...
def abrir_editor_integrado(ruta_proyecto, nombre_proyecto):
    ...
    #editor.iconphoto(True, tk.PhotoImage(file=path))
    ...
    def create_code_theme():
        ...
        def open_theme_editor(name):
            ...
            new_tab_window.iconphoto(True, tk.PhotoImage(file=path))
        ...
        new_theme.iconphoto(True, tk.PhotoImage(file=path))
    ...
    def name_new_file():
        ...
        name.iconphoto(True, tk.PhotoImage(file=path))
        name.title('New File')
    ...
    def name_new_folder():
        ...
        foldername.iconphoto(True, tk.PhotoImage(file=path))
...
def config_editors():
    ...
    config_editor.iconphoto(True, tk.PhotoImage(file=path))
...
def config_github():
    ...
    config_github.iconphoto(True, tk.PhotoImage(file=path))
...
def config_openai():
    ...
    config_openai.iconphoto(True, tk.PhotoImage(file=path))
...
def select_terminal():
    ...
    setting_terminal.iconphoto(True, tk.PhotoImage(file=path))
...
path = resource_path("software.png")
